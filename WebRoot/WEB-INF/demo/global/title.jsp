<%@ page contentType="text/html;charset=UTF-8"%>
	<div region="north" border="false" style="height:80px;background-image: url('${base}/commons/images/head.gif');background-color: #EEF9FB;background-repeat: no-repeat;">
		<div style="padding-left: 15px;padding-top: 5px;">
			...
			<a href="javascript:void(0)" id="$logger" class="easyui-splitbutton" menu="#logger" iconCls="icon-doc">日志查看</a>
		...
		<div id="security" style="width:150px;">
			...
			<div class="menu-sep"></div>
			<div iconCls="icon-undo" onclick="return isExit();">退出登录</div>
		</div>
		<div id="logger" style="width:150px;">
			<div iconCls="icon-key" onclick="gotoUrl('${base}/system/config/log/list${ext}')">日志全局配置</div>
			<div class="menu-sep"></div>
