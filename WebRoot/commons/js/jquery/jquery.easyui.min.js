...
$("<td><a href=\"#\" icon=\"pagination-first\"></a></td>").appendTo(tr);
$("<td><a href=\"#\" icon=\"pagination-prev\"></a></td>").appendTo(tr);
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
$("<span style=\"padding-left:6px;\"></span>").html(_5c.beforePageText).wrap("<td></td>").parent().appendTo(tr);
$("<td><input class=\"pagination-num\" type=\"text\" value=\"1\" size=\"2\"></td>").appendTo(tr);
$("<span style=\"padding-right:6px;\"></span>").wrap("<td></td>").parent().appendTo(tr);
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
$("<td><a href=\"#\" icon=\"pagination-next\"></a></td>").appendTo(tr);
$("<td><a href=\"#\" icon=\"pagination-last\"></a></td>").appendTo(tr);
if(_5c.showRefresh){
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
$("<td><a href=\"#\" icon=\"pagination-load\"></a></td>").appendTo(tr);
}
if(_5c.buttons){
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
...
$("<a href=\"#\"></a>").addClass("l-btn").css("float","left").text(btn.text||"").attr("icon",btn.iconCls||"").bind("click",eval(btn.handler||function(){
...
},beforePageText:"页码",afterPageText:"到 {pages}",displayMsg:"本页从 {from}到{to}条 / 共{total}条记录"};
})(jQuery);
(function($){
function _7c(_7d){
var _7e=$(_7d);
...
var tool=$("<a href=\"#\"></a>").appendTo(_1c8);
tool.css("float","left");
...
var _1ca=$("<a href=\"#\"></a>").appendTo(_1c9);
if(p.handler){
...
$("<a></a>").attr("href","#").text(_1e2).css("margin-left",10).bind("click",eval(_1e1[_1e2])).appendTo(tb).linkbutton();
}
}
...
var tool=$("<a href=\"#\"></a>").appendTo(_231);
...
var _24e=$("<a href=\"#\" class=\"tabs-inner\"></a>").appendTo(tab);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"该字段必须填写!",invalidMessage:null,rules:{email:{validator:function(_2fb){
...
},message:"Email地址格式不正确."},url:{validator:function(_2fc){
...
},message:"请输入长度 {0} 到 {1}之间."},remote:{validator:function(_2ff,_300){
var data={};
data[_300[1]]=_2ff;
...
$("<a href=\"#\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_6ce);
$("<a href=\"#\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_6ce);
...
var ok=$("<a href=\"#\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_6e3);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
