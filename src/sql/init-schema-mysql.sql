...
create table t_system_user_info(id int not null auto_increment primary key, username varchar(50) unique not null, password varchar(50) not null, cnname varchar(50),email varchar(50),enabled int, account_expired int, account_locked int, credentials_expired int);
create table t_system_role_info(id int not null auto_increment primary key, name varchar(50) unique not null, cnname varchar(50));
create table t_system_resource_info(id int not null auto_increment primary key, name varchar(50) unique not null,path varchar(200) unique not null, cnname varchar(50));
create table t_system_user_role(user_id int,role_id int);
create table t_system_role_resource(role_id int,resource_id int);
create table t_template_info(id int not null auto_increment primary key,name varchar(50) unique not null,template_path varchar(100) not null,html_path varchar(100) not null,last_date datetime,description varchar(100));
