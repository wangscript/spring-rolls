...
import org.dily.jdbc.SequenceGenerator;
import org.dily.jdbc.dialect.Page;
import org.dily.log.Log;
import org.dily.log.LoggerFactory;
import org.dily.nosql.mongodb.GenericMonogDBNativeDao;
 ...
 * <br>包及类名(Package Class): <b>org.dily.orm.MongoDBOrmDao.java</b>
 */
			...
			for(Field field : fields){
				...
				try {
					...
					if(primaryKey!=null){
						...
						}else if(primaryKey.autoGenerateMode() == AUTO_GENERATE_MODE.DILY_SEQUENCE){
