...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils{
	...
	public static String getBuildUpdateSql(Object bean,String pkName)throws IllegalAccessException,InvocationTargetException, NoSuchMethodException {
		...
		for (int i = 0; i < descriptors.length; i++) {
			...
			if (!propertyName.equalsIgnoreCase("class")&&!propertyName.equalsIgnoreCase("insertDate")&&!propertyName.equalsIgnoreCase("businessCode")&&PropertyUtils.getReadMethod(descriptors[i]) != null&&!fieldName.equals(pkName)&&!isNotMapping(bean.getClass(),propertyName)&&!isNotUpdate(bean.getClass(),propertyName)) {
