					...
					<tr>
						...
						<td>
							<table style="border: solid 1px ; border-color :#afafaf; padding: 8px;">
								...
								<tr>
									<td><input id="ip" name="ip"/></td><td><a href="#" onclick="return add();" class="easyui-linkbutton">添加</a></td>
									<script>
										function add(){
								...
								<c:forEach items="${ips}" var="ip">
									<tr>
										<td>${ip}</td><td><a class="easyui-linkbutton" href="${base}/system/config/ip/remove${ext}?ip=${ip}">移除</a></td>
									</tr>
								</c:forEach>
							</table>
						</td>
