<%@ page contentType="text/html;charset=UTF-8"%>
	...
	<div region="west" split="true" icon="icon-home" title="功能菜单" style="width:200px;padding1:1px;overflow:hidden;">
		<div class="easyui-accordion" fit="true" border="false" style="background-color: #EFEFEF;">
			<div title="系统管理" icon="icon-security" selected="true" style="overflow:auto;padding-left: 20px;">
				<div><a href="${base}/system/hardware/list${ext}" class="easyui-linkbutton" plain="true" iconCls="icon-cl">硬件情况</a></div>
			...
			<div title="日志查看" icon="icon-date" style="padding-left: 20px;">
