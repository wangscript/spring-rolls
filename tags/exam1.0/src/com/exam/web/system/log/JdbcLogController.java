package com.exam.web.system.log;
...
import com.exam.entity.system.Log;
import com.exam.service.system.LogService;
import com.exam.web.BaseController;

@Security
@ShowLabel("SQL语句日志")
@Controller("/system/log/jdbc")
public class JdbcLogController extends BaseController{
	...
	public void list(ModelAndView mv){
		mv.forward(getPage("/log/jdbc/list.jsp"));
	}
	...
	public ModelAndView detail(ModelAndView mv){
		...
		return mv.redirect(getRedirect("/system/log/jdbc"));
	}
