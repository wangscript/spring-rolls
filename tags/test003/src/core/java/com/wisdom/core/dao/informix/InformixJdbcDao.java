package com.wisdom.core.dao.informix;
 ...
 * <br>项 目 信 息:wisdom.3.0:com.wisdom.core.dao.informix.InformixJdbcDao.java
 */
@SuppressWarnings("unchecked")
public final class InformixJdbcDao extends BaseJdbcTemplate{

	public InformixJdbcDao(DataSource dataSource) {
		super(dataSource);
	}
	
	public InformixJdbcDao(DataSource dataSource,int mappingStrategy) {
