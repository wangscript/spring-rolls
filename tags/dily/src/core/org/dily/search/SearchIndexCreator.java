...
import org.dily.search.annotation.KeyWord;
import org.dily.search.annotation.SortWord;
import org.dily.search.annotation.TextWord;
 ...
 * 包及类名(Package Class): <b>org.dily.search.SearchIndexCreator.java</b>
 */
public class SearchIndexCreator {
	...
	private static String getIndexName(Class<?> clazz) {
		org.dily.search.annotation.Index index = clazz.getAnnotation(org.dily.search.annotation.Index.class);
		if (index == null) {
