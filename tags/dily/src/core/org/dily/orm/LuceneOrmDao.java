...
import org.dily.search.SearchIndexCreator;
/**
 * 功 能 描 述:<br>
 * 基于Lucene的数据库操作映射DAO，目的在于操作数据库的同时，为大文本字段建立索引，便于检索。
 * <br>代 码 作 者:曹阳(CaoYang)
 * <br>开 发 日 期:2011-10-14下午03:08:49
 * <br>项 目 信 息:dily:org.dily.orm.LuceneOrmDao.java
 */
@SuppressWarnings("unchecked")
public class LuceneOrmDao <T , PK extends Serializable> implements BaseOrmDao<T , PK>{
	...
	public void updateNotNull(T bean) throws Exception {
		logger.warn("没有实现BaseOrmDao接口相关方法,请勿调用!");
	}
