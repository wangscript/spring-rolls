 ...
 * <br>包及类名(Package Class): <b>org.dily.ioc.ApplicationContext.java</b>
 */
public class ApplicationContext {
	...
	static{
		try {
			Class.forName("org.dily.ioc.ClassScanner");
	...
	private static void invoke(String priority){
		try {
			...
			if(length>3){
				...
				String className = priority.substring(0,methodIndex);
